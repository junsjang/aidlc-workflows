...
- **11 domain experts**: Each stage leverages the appropriate agent persona; the `.cursor/agents/` files serve both inline framing and native `task`-tool dispatch.
